...
`ifdef SCAIEV_ENABLE
  ...
  logic [31:0] scaiev_realign_rdInstr;
  logic [CVA6Cfg.INSTR_PER_FETCH-1:0][CVA6Cfg.XLEN-1:0] scaiev_realign_PC;
  logic scaiev_decode_isFlushing;
  logic scaiev_decode_isStalling;
  logic [31:0] scaiev_decode_rdInstr;
  scaiev_instr_decoded_t scaiev_decode_decInstr;
  logic [4:0] scaiev_decode_instr_rd;
  logic scaiev_realign_isFlushing;
  logic scaiev_realign_isStalling;
  logic scaiev_issue_isFlushing;
  logic scaiev_issue_isStalling;
  logic scaiev_flush_ctrl_id;
  logic scaiev_issue_isValid;
  logic scaiev_issue_pipeinto_scaievfu;
  logic [CVA6Cfg.XLEN-1:0] scaiev_issue_rdRS1;
  logic [CVA6Cfg.XLEN-1:0] scaiev_issue_rdRS2;
  logic [31:0] scaiev_issue_rdInstr;
  ...
  logic [CVA6Cfg.VLEN-1:0] scaiev_issue_PC;
  logic [CVA6Cfg.TRANS_ID_BITS-1:0] scaiev_issue_trans_id_o;
  logic [31:0] scaiev_execute_rdInstr;
  logic [CVA6Cfg.XLEN-1:0] scaiev_execute_PC;
  ...
  logic scaiev_decode_isSCAIEV;
  logic scaiev_decode_isSCAIEV_hasRS1;
  logic scaiev_decode_isSCAIEV_hasRS2;
  logic scaiev_decode_isSCAIEV_hasRD;
  logic scaiev_decode_isSCAIEV_hasRD_decoupled;
  logic scaiev_decode_isBranch;
  logic scaiev_decode_isLoad;
  logic scaiev_decode_isStore;
  logic scaiev_issue_stall;
  logic scaiev_issue_flush;
  logic scaiev_issue_mem_stall;
  ...
  logic [INSTRQUEUE_ID_WIDTH-1:0] scaiev_realign_instrqueueID;
  logic [INSTRQUEUE_ID_WIDTH-1:0] scaiev_decode_instrqueueID;
